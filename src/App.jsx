...
function getDefaultDB(country){
  ...
  return{
    ...
    taxi:{"🚕 一般タクシー":{minPerKm:Math.round(400/r),baseMin:Math.round(500/r),baseAvg:Math.round(700/r),surge:{"深夜":1.3,"夕方":1.2,"朝":1.1,"昼":1.0},trend:"+8%",reason:{ja:"一般的なタクシー相場（目安）。",en:"General taxi price guide.",zh:"一般出租车价格参考。",ko:"일반 택시 가격 기준."}},"📱 Grab/Uber":{minPerKm:Math.round(500/r),baseMin:Math.round(600/r),baseAvg:Math.round(800/r),surge:{"深夜":1.5,"夕方":1.3,"朝":1.1,"昼":1.0},trend:"+10%",reason:{ja:"配車アプリは事前に料金確認できて安心。",en:"Ride-hailing apps show prices upfront.",zh:"网约车App可提前确认费用，安心便捷。",ko:"차량 호출 앱은 요금을 미리 확인할 수 있어 안심."}},"🛺 トゥクトゥク":{minPerKm:Math.round(300/r),baseMin:Math.round(400/r),baseAvg:Math.round(600/r),surge:{"深夜":1.5,"夕方":1.3,"朝":1.1,"昼":1.0},trend:"+8%",reason:{ja:"乗車前に値段を確認してください。",en:"Always confirm price before boarding.",zh:"上车前务必确认价格。",ko:"탑승 전 반드시 가격을 확인하세요."}},"🚌 バス":{minPerKm:Math.round(10/r),baseMin:Math.round(150/r),baseAvg:Math.round(200/r),surge:{"深夜":1.0,"夕方":1.0,"朝":1.0,"昼":1.0},trend:"+3%",reason:{ja:"公共交通機関は最もコスパが良い。",en:"Public transport offers the best value.",zh:"公共交通是性价比最高的出行方式。",ko:"대중교통이 가장 가성비가 좋습니다."}}},
